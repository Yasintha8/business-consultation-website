...
const Footer = () => {
  return (
    <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
       <div className='container mx-auto flex flex- md:flex-row flex-col justify-between items-start'>
        {/* first column */}
        <div className='w-full md:w-1/3 mb-8 md:mb-0'>
          <img src={assets.logo_dark} alt="" />
          <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Possimus at minus quidem explicabo laudantium aspernatur nobis veritatis saepe odit magni!</p>
        </div>
        {/* second column */}
        ...
        <div className='w-full md:w-1/3'>
          ...
          <p className='text-gray-400 mb-4 max-w-80'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cumque, porro?</p>
